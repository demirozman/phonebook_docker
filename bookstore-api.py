...
app.config['MYSQL_DATABASE_USER'] = 'dmr'
app.config['MYSQL_DATABASE_PASSWORD'] = 'P1234567-8'
...
def init_bookstore_db():
    ...
    VALUES
        ...
        ("Where the Yücel home", "yakin sakin", 0 ),
...
# Write a function named `home` which returns 'Welcome to the dmr's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to dmr's Bookstore API Service"
